...
class FancyTabItem extends StatefulWidget {
  FancyTabItem(
      {@required this.title,
  ...
  @override
  _FancyTabItemState createState() => _FancyTabItemState();
}
...
class _FancyTabItemState extends State<FancyTabItem> {
  ...
  @override
  void didUpdateWidget(FancyTabItem oldWidget) {
