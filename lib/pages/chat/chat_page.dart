        ...
        children: <Widget>[
          document['type'] == 0
              ...
              ? Container(
                  ...
                  width: 200.0,
                  decoration: BoxDecoration(color: Theme.of(context).cardColor, borderRadius: BorderRadius.circular(8.0)),
            ...
            isLastMessageLeft(index)
                ? Container(
                    child: Text(
                      ...
                      style: TextStyle(color: Theme.of(context).cardColor, fontSize: 12.0, fontStyle: FontStyle.italic),
                    ),
  ...
  Widget buildSticker() {
    return Container(
      ...
      decoration: new BoxDecoration(
          border: new Border(top: new BorderSide(color: Theme.of(context).cardColor, width: 0.5)), color: Colors.white),
